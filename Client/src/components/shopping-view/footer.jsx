...
{/* Top Feature Bar - Responsive (Mobile = Scroll + Split Lines, Desktop = Grid) */}
<div className="bg-[#00B0BA] text-white text-[12px] sm:text-sm py-6 px-2 sm:px-6 md:px-12
  flex md:grid md:grid-cols-5 md:gap-4 overflow-x-auto whitespace-nowrap">
  ...
  {[
    ...
    <div
      ...
      className="flex flex-col items-center justify-center text-center 
                 flex-1 min-w-[70px] md:min-w-0 md:px-2"
    >
      {/* Icon */}
      ...
      {/* Label */}
      <span
        className="mt-1 leading-tight hidden md:inline"
      >
