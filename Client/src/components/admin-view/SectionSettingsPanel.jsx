...
export default function SectionSettingsPanel({ block, onSave, onCancel, onLiveUpdate }) {
  ...
  onChange={(e) => {
    ...
    newWidths = newWidths.map(() => evenWidth); // reset all to even %
...
>
  ...
  <div key={colIndex} className="mb-6">
    ...
    <div className="space-y-2 pl-2 border-l border-gray-100 ml-2 mt-2">
      <label className="text-xs font-semibold text-gray-600 block">Column {colIndex + 1} Styles</label>
      ...
      <Input
        ...
        onChange={(e) => {
          ...
          updated[colIndex] = { ...updated[colIndex], backgroundColor: e.target.value };
      ...
      <Input
        ...
        onChange={(e) => {
          const updated = [...(formData.columnStyles || [])];
          updated[colIndex] = { ...updated[colIndex], padding: e.target.value };
          handleChange("columnStyles", updated);
        }}
        className="w-full text-xs"
      />
      ...
      <select
        ...
        onChange={(e) => {
          const updated = [...(formData.columnStyles || [])];
          updated[colIndex] = { ...updated[colIndex], textAlign: e.target.value };
          handleChange("columnStyles", updated);
        }}
      >
      ...
      <select
        ...
        onChange={(e) => {
          const updated = [...(formData.columnStyles || [])];
          updated[colIndex] = { ...updated[colIndex], alignItems: e.target.value };
          handleChange("columnStyles", updated);
        }}
      >
